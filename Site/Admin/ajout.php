...
include_once "../Actions/ajoutAction.php";
        ...
        <div class="content">
            ...
            <form class="border bg-white p-3 shadow" action="" method="POST">
              <div class="form-group">
                ...
                <input class="border-2 bg-light shadow border-primary form-control" type="text" name="nom" id="nom" class="form-control" required>
              </div>
              <div class="form-group">
                <label for="prenom">Prénom :</label>
                <input class="border-2 shadow bg-light border-primary form-control" type="text" name="prenom" id="prenom" class="form-control" required>
              </div>
              <div class="form-group">
                <label for="email">Email :</label>
                <input class="border-2  shadowbg-light border-primary form-control" type="email" name="email" id="email" class="form-control" required>
              </div>
              <div class="form-group">
                <label for="dateNaissance">Date de naissance :</label>
                <input class="border-2 shadow  bg-light border-primary form-control" type="date" name="dateNaissance" id="dateNaissance" class="form-control" required>
              </div>
              <div class="form-group">
                <label for="sexe">Sexe :</label>
                <select name="sexe" id="sexe" class="border-2 shadow  bg-light border-primary form-control" required>
              ...
              <div class="form-group">
                ...
                <input class="border-2 shadow bg-light border-primary form-control" type="text" name="ecole" id="ecole" class="form-control" required>
              </div>
              <div class="form-group">
                <label for="filiere">Filière :</label>
                <input class="border-2 shadow  bg-light border-primary form-control" type="text" name="filiere" id="filiere" class="form-control" required>
              </div>
              <div class="form-group">
                <label for="niveauEtude">Niveau d'étude :</label>
                <input class="border-2 shadow bg-light border-primary form-control" type="text" name="niveauEtude" id="niveauEtude" class="form-control" required>
              </div>
              <div class="form-group">
